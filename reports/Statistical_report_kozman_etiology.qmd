---
title: "Statistical report: Etiology of heart failure across the ejection fraction spectrum and association with prognosis: an analyses from the Swedish Heart Failure Registry"
subtitle: Draft
date: "`r Sys.Date()`"
...
The primary outcome was included as the Nelson-Aalen estimator.
...
FRÅGA: VAD ÄR BRA NAMN PÅ PRIM ET GRUPPER?

FRÅGA: Kolla noga igenom variabler i tabell och vilka som ska justeras för i modeller. 

Note to self: Om inte ska presentera estimat från andra variabler, inkludera som kontinuerliga med splines. 
...
FRÅGA: Fundera på om verkligen ska ha Other som referens. Detta är en slaskgrupp. Bättre att ha en väldefinerad entitet som ref i både cox och denna? 
...
Data were censored at death (if itself not an event), 2021-12-31 or emigration from Sweden. 
