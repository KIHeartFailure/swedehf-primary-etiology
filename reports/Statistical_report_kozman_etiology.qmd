---
title: "Statistical report: Primary etiology across the EF spectrum: an analyses from the Swedish Heart Failure Registry"
subtitle: Draft
date: "`r Sys.Date()`"
...
TO DO: Skicka projektansökan till swedehf styrgrupp. 
...
FRÅGA: Ska klippa tid vid 5 år?

FRÅGA: Ska vara cvd/1hfh? eller acdöd/1hfh? (lars skrev död)
