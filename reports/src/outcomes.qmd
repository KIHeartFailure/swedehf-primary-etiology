...
outall_female <- outcomesfunc(data = rsdata %>% filter(shf_sex == "Female"), impdata = imprsdatafemale, novars = "shf_sex")
...
outall_male <- outcomesfunc(data = rsdata %>% filter(shf_sex == "Male"), impdata = imprsdatamale, novars = "shf_sex")
